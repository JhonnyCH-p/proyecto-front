...
export const HomePage = () => {
  ...
  const { propiedades, setPropiedades, setFiltros } = usePropiedadStore()
  ...
  return (
    <div>
      <section className="relative h-[85vh] min-h-[550px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#2C3E50]/30 z-10" />

        <div className="absolute inset-0 z-20 flex items-start justify-center pt-20 md:pt-28 px-4">
          <div className="w-full max-w-2xl flex gap-2">
            <Input
              ...
              className="flex-1 text-base py-2 bg-white/90 backdrop-blur-sm border-white/50 focus:ring-2 focus:ring-primary focus:border-transparent"
            />
            <Button onClick={ManejarBusqueda} size="md" className="px-4">  Buscar </Button>
          </div>
        </div>

        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 text-white/60 text-sm animate-bounce hidden md:block"> Desplázate para ver más</div>
      </section>

      <section className="container-custom py-12">
        <h2 className="text-3xl font-bold text-center text-[#2C3E50] mb-8"> Propiedades Destacadas </h2>
        ...
        <div className="text-center mt-8">
          <Button variant="outline" onClick={() => navigate('/propiedades')}>  Ver todas las propiedades   </Button>
        </div>
      </section>
  ...
  <div className="container-custom">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="group bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 text-center border border-gray-100">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">  Encuentra la casa o departamento perfecto para ti y tu familia. </p>
      </div>
      ...
      <div className="group bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 text-center border border-gray-100">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">  Publica tu propiedad y conéctala con los compradores ideales. </p>
      </div>
      ...
      <div className="group bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 text-center border border-gray-100">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">  Encuentra el lugar perfecto para alquilar sin complicaciones.  </p>
      </div>
    </div>
  </div>
</section>
